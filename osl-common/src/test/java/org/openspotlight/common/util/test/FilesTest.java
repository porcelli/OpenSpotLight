...
public class FilesTest {
    ...
    private static String RELATIVE_PATH_FILE = removeBegginingFrom(__LOWEST_PATH, _TEST_FILE);
    ...
    @SuppressWarnings("boxing")
    @Test
    public void shouldDeleteValidDirs()
        throws Exception {
        delete(_LOWER_PATH);
    ...
    @SuppressWarnings("boxing")
    @Test
    public void shouldDeleteValidFiles()
        throws Exception {
        delete(_TEST_FILE);
    ...
    @SuppressWarnings("boxing")
    @Test
    public void shouldListFileNamesInARecursiveWay()
        throws Exception {
    ...
    public void shouldThrowExceptionWhenGettingInvalidFile()
        throws Exception {
    ...
    @SuppressWarnings("boxing")
    @Test
    public void shouldWriteByteArrayFromStream()
        throws Exception {
