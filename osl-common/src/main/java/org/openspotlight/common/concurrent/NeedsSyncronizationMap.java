...
/**
 * This is a {@link Map} with a {@link LockContainer} used to synchronize all its methods. Its behavior works like
 * {@link SLCollections#synchronizedMap(Map)}. The synchronization during iterations to avoid
