...
/**
 * The Class GossipExecutor has this name because it stay telling every listener
 * what is going on ;-).
 */
public class GossipExecutor extends ThreadPoolExecutor {
	...
	public static interface TaskListener {
		 ...
		 *            the t
		 */
		public void afterExecutingTask(Runnable r, Throwable t);
		 ...
		 *            the r
		 */
		public void beforeExecutingTask(Thread t, Runnable r);
	}

	/**
	 * The listener interface for receiving thread events. The class that is
	 * interested in processing a thread event implements this interface, and
	 * the object created with that class is registered with a component using
	 * the component's <code>addThreadListener<code> method. When
