...
/**
 * Interface to be used to share the same lock object when there's a complex object three with the same lock.
 * <ul>
 * <li>When the new object contains another {@link LockContainer}, use its "parent" container as a lock object</li>
 ...
 * <li>If the public method contains only a simple delegation to an synchronized object with the same lock, there's no need to
 * synchronize it</li>
 ...
 * </pre>
 * 
 * <b>WARNING:</b> Use the {@link #getLockObject()} method to get the lock object. Do not use the parent itself NEVER!
 * 
 * @author feu
 */
