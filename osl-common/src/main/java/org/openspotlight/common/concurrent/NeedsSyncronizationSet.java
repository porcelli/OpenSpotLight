...
/**
 * This is a {@link Set} with a {@link LockContainer} used to synchronize all its methods. Its behavior works like
 * {@link SLCollections#synchronizedSet(Set)}. The synchronization during iterations to avoid
