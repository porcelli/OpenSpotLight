...
public class CustomizedFormat {
    ...
    public String format(final String s) {
        if (sizeOfParameters != 1) { throw new IllegalArgumentException("Expected " + sizeOfParameters + " parameters"); }
    ...
    public String format(final String s1,
                          final String s2) {
        if (sizeOfParameters != 2) { throw new IllegalArgumentException("Expected " + sizeOfParameters + " parameters"); }
        final StringBuilder b = new StringBuilder();
        b.append(items[0]);
        b.append(s1);
        b.append(items[1]);
