...
public class JCRUtil {
	 ...
	 * @throws RepositoryException the repository exception
	 */
	public static Node getChildNode(final Node node, final String name) throws RepositoryException {
		try {
	 ...
	 */
	public static Value createValue(final Session session, final Object value) throws JCRUtilException {
		try {
			Value jcrValue = null;
	 ...
	 * @throws JCRUtilException the JCR util exception
	 */
	public static Value[] createValues(final Session session, final Object value) throws JCRUtilException {
		try {
