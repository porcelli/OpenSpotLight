...
public class Assertions {
    ...
    public static void checkCondition(final String name,
        ...
        if (!condition) { throw logAndReturn(new IllegalStateException(
    ...
    public static <T> void checkEachParameterNotNull(final String name,
                                                      final T... parameters) {
        if (parameters == null) { throw logAndReturn(new IllegalArgumentException(
                                                            MessageFormat.format(
                                                                                 Messages
                                                                                     .getString("Assertions.notNullMandatory"), name))); //$NON-NLS-1$
        }
        for (final Object parameter: parameters) {
            if (parameter == null) { throw logAndReturn(new IllegalArgumentException(
                                                                MessageFormat.format(
                                                                                     Messages
                                                                                         .getString("Assertions.notNullMandatory"), name))); //$NON-NLS-1$
    ...
    public static void checkNotEmpty(final String name,
        ...
        if (parameter == null || parameter.size() == 0) { throw logAndReturn(new IllegalArgumentException(
                                                            MessageFormat.format(
                                                                                 Messages
    ...
    public static void checkNotEmpty(final String name,
        ...
        if (parameter == null || parameter.trim().length() == 0) { throw logAndReturn(new IllegalArgumentException(
                                                            MessageFormat.format(
                                                                                 Messages
                                                                                     .getString("Assertions.notEmptyMandatory"), name))); //$NON-NLS-1$
        }
    ...
    public static <T> void checkNotEmpty(final String name,
                                          final T[] parameter) {
        if (parameter == null || parameter.length == 0) { throw logAndReturn(new IllegalArgumentException(
                                                            MessageFormat.format(
                                                                                 Messages
                                                                                     .getString("Assertions.notEmptyMandatory"), name))); //$NON-NLS-1$
        }
