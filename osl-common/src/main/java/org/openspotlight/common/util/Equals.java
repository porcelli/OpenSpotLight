...
public class Equals {
	 ...
	 * 
	 * @param <T>
	 *            Type of item been comparated
	 * @param thisObjectType
	 *            the this object type
	 * @param thisObject
	 *            the this object
	 * @param thatObject
	 *            the that object
	...
	public static <T> boolean eachEquality(final Class<T> thisObjectType,
			final T thisObject, final Object thatObject, final String fieldName) {
	...
	public static boolean eachEquality(final short of, final short andOf) {
		return of == andOf;
	}
