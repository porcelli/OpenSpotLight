...
public class Compare {
    ...
    public static <T> int compareAll(final T[] of,
                                      final T andOf[]) {
        if ((of == null) && (andOf == null)) { return 0; }
        if (andOf == null) { return -1; }
        if (of == null) { return 1; }
    ...
    public static <T> int npeSafeCompare(final T thisObject,
                                          final T thatObject) {
        if (thisObject == thatObject) { return 0; }
        if ((thisObject != null) && (thatObject == null)) { return 1; }
        if (thisObject == null) {
            if ((thatObject != null)) {
                return -1;
            } else {
        ...
        if (thisObject.equals(thatObject)) { return 0; }
