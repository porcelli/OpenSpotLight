...
/**
 * The Interface for a link between Program - Natural Include.
 * 
 * @author Luiz Fernando Teston - feu.teston@caravelatech.com 
 */
@SLDescription("Program - Natural Include")
public interface ProgramNaturalIncludeLink extends SLLink {
    //
}
