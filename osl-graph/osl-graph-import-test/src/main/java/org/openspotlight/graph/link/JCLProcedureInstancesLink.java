...
/**
 * The Interface for a link between JCL Procedure Instances.
 * 
 * @author Luiz Fernando Teston - feu.teston@caravelatech.com 
 */
@SLDescription("JCL Procedure Instances")
public interface JCLProcedureInstancesLink extends SLLink {
    //
}
