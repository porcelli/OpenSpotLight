...
/**
 * The Interface for a link between Program Read Logical File.
 * 
 * @author Luiz Fernando Teston - feu.teston@caravelatech.com 
 */
@SLDescription("Program Read Logical File")
public interface ProgramReadLogicalFileLink extends SLLink {
    //
}
