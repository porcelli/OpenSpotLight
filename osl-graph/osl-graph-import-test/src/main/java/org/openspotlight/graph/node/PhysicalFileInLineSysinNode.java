...
/**
 * The Interface for node Physical File.In-Line Sysin.
 * 
 * @author Luiz Fernando Teston - feu.teston@caravelatech.com 
 */
@SLDescription("Physical File.In-Line Sysin")
public interface PhysicalFileInLineSysinNode extends SLNode {
