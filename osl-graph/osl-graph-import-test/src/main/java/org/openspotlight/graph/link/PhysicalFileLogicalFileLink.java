...
/**
 * The Interface for a link between Physical File - Logical File.
 * 
 * @author Luiz Fernando Teston - feu.teston@caravelatech.com 
 */
@SLDescription("Physical File - Logical File")
public interface PhysicalFileLogicalFileLink extends SLLink {
    //
}
