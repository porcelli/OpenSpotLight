...
/**
 * The Interface for a link between Step Using Proc Variable.
 * 
 * @author Luiz Fernando Teston - feu.teston@caravelatech.com 
 */
@SLDescription("Step Using Proc Variable")
public interface StepUsingProcVariableLink extends SLLink {
    //
}
