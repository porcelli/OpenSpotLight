...
/**
 * The Interface for a link between Step Passing Proc Variable.
 * 
 * @author Luiz Fernando Teston - feu.teston@caravelatech.com 
 */
@SLDescription("Step Passing Proc Variable")
public interface StepPassingProcVariableLink extends SLLink {
    //
}
