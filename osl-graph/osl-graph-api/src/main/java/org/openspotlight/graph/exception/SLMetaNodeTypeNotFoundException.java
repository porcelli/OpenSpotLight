 ...
 * @author porcelli
 */
public class SLMetaNodeTypeNotFoundException extends SLGraphException {
     ...
     */
    public SLMetaNodeTypeNotFoundException(
                                            String metaNodeTypeName, Throwable cause ) {
        super("SLMetaNodeType " + metaNodeTypeName + " not found.", cause);
    }
