...
public class SLGraphQueryStackBehaviorTest extends AbstractGeneralQueryTest {
    ...
    @Test
    public void testVerifyWhereInStack() throws SLQueryException, SLGraphSessionException, SLInvalidQuerySyntaxException {
        ...
        final NodeWrapper[] inputWrappers = this.wrapNodes(inputResult.getNodes());
        ...
        new AssertResult() {
            public void execute() {
                ...
                assertThat(new NodeWrapper(org.openspotlight.graph.test.domain.JavaPackage.class.getName(), "queryTest",
                                           "java.util"), is(inputWrappers[0]));
            }
        }.execute();

        printInfo = true;
        this.printResult(inputResult.getNodes());
    ...
    @Test
    public void testVerifyWhereInStack2() throws SLQueryException, SLGraphSessionException, SLInvalidQuerySyntaxException {
        ...
        final NodeWrapper[] wrappers2 = this.wrapNodes(resultData.getNodes());

        this.printResult(resultData.getNodes());
    ...
    @Test
    public void testVerifyWhereInStack3() throws SLQueryException, SLGraphSessionException, SLInvalidQuerySyntaxException {
