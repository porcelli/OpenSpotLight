...
public class TestSLQueryTextInternal extends AbstractGeneralQueryTest {
    ...
    public void testNotConditionalOperator() throws Throwable {
        ...
        new AssertResult() {
            public void execute() {
                ...
                assertThat(new NodeWrapper(JavaClass.class.getName(), "java.util",
    ...
    public void testNotRelationalOperator() throws Throwable {
        ...
        new AssertResult() {
            public void execute() {
                ...
                assertThat(new NodeWrapper(JavaInterface.class.getName(), "java.lang",
                ...
                assertThat(new NodeWrapper(JavaInterface.class.getName(), "java.io",
    ...
    public void testSelectAllJavaClasses() throws Throwable {
        ...
        new AssertResult() {
            public void execute() {
                ...
                assertThat(new NodeWrapper(JavaClass.class.getName(), "java.security",
    ...
    public void testSelectAllPackages() throws Throwable {
        ...
        new AssertResult() {
            public void execute() {
                assertThat(wrappers.length, is(4));
                assertThat(new NodeWrapper(JavaPackage.class.getName(), "queryTest",
    ...
    public void testSelectAllTypesOnWhere() throws Throwable {
        ...
        new AssertResult() {
            public void execute() {
                ...
                assertThat(new NodeWrapper(JavaTypeMethod.class.getName(), "java.util.Map",
    ...
    public void testSelectByLinkWithAnySide() throws Throwable {
        ...
        new AssertResult() {
            public void execute() {
                ...
                assertThat(new NodeWrapper(JavaTypeMethod.class.getName(), "java.util.List",
                ...
                assertThat(new NodeWrapper(JavaTypeMethod.class.getName(), "java.util.Set",
    ...
    public void testSelectDateMethods() throws Throwable {
        ...
        new AssertResult() {
            public void execute() {
                ...
                assertThat(new NodeWrapper(JavaTypeMethod.class.getName(), "java.util.Date",
                                           "equals"), isOneOf(wrappers));
                assertThat(new NodeWrapper(JavaTypeMethod.class.getName(), "java.util.Date",
