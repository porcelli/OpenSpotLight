...
public class SLGraphQueryTest extends AbstractGeneralQueryTest {
    ...
    public static void main(final String[] args) throws Exception {
        AbstractGeneralQueryTest test = null;
        try {
            int count = 0;
            final Map<Integer, Method> methodMap = new TreeMap<Integer, Method>();
            final Method[] methods = SLGraphQueryTest.class.getDeclaredMethods();
            ...
            test = new SLGraphQueryTest(SortMode.SORTED, true);
            int option = 0;
     ...
     */
    public SLGraphQueryTest(
            final SortMode sortMode, final boolean printInfo) throws Exception {
    ...
    public void testDifferentQueryIds() throws SLInvalidQuerySyntaxException, SLInvalidQueryElementException {
        ...
        final QueryApi initQuery = session.createQueryApi();
        ...
        final QueryResult initialData = initQuery.execute(sortMode, printInfo);

        final QueryApi query = session.createQueryApi();

        query.select().allTypes().byLink(TypeContainsMethod.class.getName()).b().selectEnd();

        final QueryResult result = query.execute(new String[]{initialData.getNodes().get(0).getID()}, sortMode, printInfo);

        final QueryApi query2 = session.createQueryApi();

        query2.select().allTypes().byLink(PackageContainsType.class.getName()).b().selectEnd();

        final QueryResult result2 = query2.execute(new String[]{initialData.getNodes().get(0).getID()}, sortMode, printInfo);
    ...
    public void testMultipleEnclosedBrackets() {
        ...
        try {
            ...
            final QueryResult result = query.execute(SortMode.SORTED, true);
    ...
    public void testSelectAllPackages() {
        ...
        try {
            ...
            final QueryResult result = query.execute(sortMode, true);
            final List<SLNode> nodes = result.getNodes();
            final NodeWrapper[] wrappers = wrapNodes(nodes);
            ...
            final QueryApi nquery = session.createQueryApi();
    ...
    public void testSelectDateMethodsLimitGeneral() {
        try {
            ...
            final QueryResult result = query.execute(sortMode, printInfo, 10, null);
            final List<SLNode> nodes = result.getNodes();
            final NodeWrapper[] wrappers = wrapNodes(nodes);
    ...
    public void testSelectDateMethodsLimitGeneral2() {
        try {
            ...
            final QueryResult result = query.execute(sortMode, printInfo, 20, null);
            final List<SLNode> nodes = result.getNodes();
            final NodeWrapper[] wrappers = wrapNodes(nodes);
    ...
    public void testSelectDateMethodsLimitGeneralOffset2() {
        try {
            ...
            final QueryResult result = query.execute(sortMode, printInfo, 20, 21);
            final List<SLNode> nodes = result.getNodes();
            final NodeWrapper[] wrappers = wrapNodes(nodes);
    ...
    public void testSelectDateMethodsLimitOffsetGeneral() {
        try {
            ...
            final QueryResult result = query.execute(sortMode, printInfo, 10, 11);
            final List<SLNode> nodes = result.getNodes();
            final NodeWrapper[] wrappers = wrapNodes(nodes);
