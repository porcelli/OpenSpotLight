...
public class SLGraphQueryTest extends AbstractGeneralQueryTest {
	...
	public static void main(final String[] args) throws Exception {
		...
		try {
			...
			test = new SLGraphQueryTest(true);
			int option = 0;
	 ...
	 *            the print info
	 */
	public SLGraphQueryTest(final boolean printInfo) throws Exception {
	...
	public void testDifferentQueryIds() throws Exception {
		...
		initQuery.select().allTypes().onWhere().selectEnd().where()
		...
		final QueryResult result = query.execute(new String[] { initialData
		...
		final QueryResult result2 = query2.execute(new String[] { initialData
				.getNodes().get(0).getId() }, sortMode, printInfo);
	...
	@Test
	public void testMultipleEnclosedBrackets() throws Exception {
		...
		.where().type(JavaType.class.getName()).subTypes().each()
				...
				.openBracket().each().property("caption").contains()
				.value("Stack").or().openBracket().each().property("caption")
				.contains().value("Currency").closeBracket().closeBracket()
				.typeEnd().whereEnd();
	 ...
	 */
	@Test
	public void testNotConditionalOperator() throws Exception {

		final QueryApi query = session.createQueryApi();
		query.select().allTypes().onWhere().selectEnd()

		.where().type(JavaType.class.getName()).subTypes().each()
				.property("caption").contains().value("Set").and().not()
				.openBracket().each().property("caption").contains()
				.value("Hash").or().each().property("caption").contains()
	 ...
	 */
	@Test
	public void testNotRelationalOperator() throws Exception {

		final QueryApi query = session.createQueryApi();

		query.select().allTypes().onWhere().selectEnd()

		.where().type(JavaInterface.class.getName()).each().property("caption")
				.not().contains().value("Set").typeEnd().whereEnd();
	 ...
	 */
	@Test
	public void testSelectAllDateMethods() throws Exception {
		final QueryApi query = session.createQueryApi();
	...
	public void testSelectAllTypes() {
		...
		.where().type(JavaType.class.getName()).subTypes().each()
				...
				.type(JavaTypeMethod.class.getName()).each()
				.property("caption").contains().value("Set").typeEnd()
				.whereEnd();
	...
	public void testSelectByCollatorKeyPrimaryChangeCase() {
		...
		query.select().allTypes().onWhere().selectEnd().where()
				.type(JavaInterface.class.getName()).each().property("caption")
				.equalsTo().value("java.util.CollecTION").typeEnd().whereEnd()
				.collator(Collator.PRIMARY);
	...
	public void testSelectByCollatorKeySecondaryChangeAccent() {
		...
		query.select().allTypes().onWhere().selectEnd().where()
				.type(JavaInterface.class.getName()).each().property("caption")
				.equalsTo().value("java.util.Çollection").typeEnd().whereEnd()
				.collator(Collator.SECONDARY);
	...
	public void testSelectByLinkCount() {
		...
		query.select().allTypes().onWhere().selectEnd().where()
				...
				.property("caption").contains().value("List").or().each()
				.property("caption").contains().value("Map").typeEnd()
				.whereEnd()

				.select().allTypes().selectEnd().where()
				.type(JavaType.class.getName()).subTypes().each()
				.property("caption").not().contains().value("Sorted").and()
				.each().link(TypeContainsMethod.class.getName()).a().count()
				.greaterThan().value(3).and().each()
	...
	public void testSelectByLinkWithAnySide() {
		...
		query.select().type(JavaInterface.class.getName()).comma()
				.type(JavaTypeMethod.class.getName()).selectEnd()

				.where().type(JavaTypeMethod.class.getName()).each()
				.property("caption").startsWith().value("get").typeEnd()
				.whereEnd()

				.select().type(JavaInterface.class.getName()).comma()
				.type(JavaTypeMethod.class.getName()).subTypes().comma()
				.byLink(TypeContainsMethod.class.getName()).any().selectEnd();
	...
	public void testSelectDateMethodsWithTagBetween30And70() {
		...
		.where().type(JavaType.class.getName()).subTypes().each()
				...
				.where().linkType(TypeContainsMethod.class.getName()).each()
				.property("tag").greaterThan().value(30).and().each()
				.property("tag").lesserThan().value(70).linkTypeEnd()
				.whereEnd();
	...
	public void testSelectDateMethodsWithTagGreaterThan50() {
		...
		.where().type(JavaType.class.getName()).subTypes().each()
				...
				.where().linkType(TypeContainsMethod.class.getName()).each()
				.property("tag").greaterThan().value(50).linkTypeEnd()
				.whereEnd();
	...
	public void testSelectDateMethodsWithTagLesserOrEqualTo30OrGreaterOrEqualTo70() {
		...
		.where().type(JavaType.class.getName()).subTypes().each()
				...
				.where().linkType(TypeContainsMethod.class.getName()).each()
				.property("tag").lesserOrEqualThan().value(30).or().each()
				.property("tag").greaterOrEqualThan().value(70).linkTypeEnd()
				.whereEnd();
	...
	public void testSelectDateMethodsWithTagLesserOrEqualTo50() {
		...
		.where().type(JavaType.class.getName()).subTypes().each()
				...
				.where().linkType(TypeContainsMethod.class.getName()).each()
				.property("tag").lesserOrEqualThan().value(50).linkTypeEnd()
				.whereEnd();
	...
	public void testSelectInterfacesWithSetOverTypesFromUtil() {
		...
		.where().type(JavaType.class.getName()).subTypes().each()
				.property("caption").startsWith().value("java.util").typeEnd()
				.whereEnd()
	...
	public void testSelectOrderByAscendingAndDescending() {
		...
		query.select().allTypes().onWhere().selectEnd().where()
				.type(JavaType.class.getName()).subTypes().each()
				.property("caption").contains().value("Set").typeEnd()
				.whereEnd().orderBy().type(JavaInterface.class.getName())
				.property("caption").ascending()
	...
	public void testSelectOrderByCrossType() {
		...
		query.select().allTypes().onWhere().selectEnd().where()
				.type(JavaType.class.getName()).subTypes().each()
				.property("caption").contains().value("Set").typeEnd()
				.whereEnd().orderBy().type(JavaType.class.getName())
				.property("caption").orderByEnd();
	...
	public void testSelectSortedSetHierarchyExecute3Times() {
		...
		.where().type(JavaInterface.class.getName()).subTypes().each()
				.property("caption").equalsTo().value("java.util.SortedSet")
				.typeEnd().whereEnd()

				.keepResult()

				.select().type(JavaInterface.class.getName()).comma()
				.byLink(JavaInterfaceHierarchy.class.getName()).b().selectEnd()
	...
	public void testSelectTypesFromMethodsWithGet() {
		...
		.where().type(JavaTypeMethod.class.getName()).each()
				...
				.byLink(TypeContainsMethod.class.getName()).a().selectEnd();
	...
	public void testSelectTypesFromUtilWithSetListOrMap() {
		...
		.where().type(JavaType.class.getName()).subTypes().each()
				.property("caption").startsWith().value("java.util").and()
				.openBracket().each().property("caption").contains()
				.value("Set").or().each().property("caption").contains()
