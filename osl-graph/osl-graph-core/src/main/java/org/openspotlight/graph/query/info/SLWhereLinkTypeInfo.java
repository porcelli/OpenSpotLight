...
public class SLWhereLinkTypeInfo {
	...
	public static class SLLinkTypeStatementInfo implements Serializable {
		...
		public SLLinkTypeConditionInfo addCondition() {
			SLLinkTypeConditionInfo conditionInfo = new SLLinkTypeConditionInfo(typeInfo);
		 ...
		 * @return the sL condition info
		 */
		public SLLinkTypeConditionInfo addCondition(SLConditionalOperatorType operator) {
			SLLinkTypeConditionInfo conditionInfo = new SLLinkTypeConditionInfo(typeInfo, operator);
			conditionInfoList.add(conditionInfo);
			conditionInfo.setOuterStatementInfo(this);
			return conditionInfo;
		}
		 ...
		 */
		public void setConditionInfoList(List<SLLinkTypeConditionInfo> conditionalInfoList) {
		...
		private void printWhereStatement(StringBuilder buffer, SLLinkTypeStatementInfo statementInfo, int tabLevel) {
			for (int i = 0; i < statementInfo.conditionInfoList.size(); i++) {
				SLLinkTypeConditionInfo conditionInfo = statementInfo.conditionInfoList.get(i);
		...
		public class SLLinkTypeConditionInfo {
			 ...
			 */
			public SLLinkTypeConditionInfo(SLWhereLinkTypeInfo linkTypeInfo) {
			 ...
			 */
			public SLLinkTypeConditionInfo(SLWhereLinkTypeInfo linkTypeInfo, SLConditionalOperatorType conditionalOperator) {
