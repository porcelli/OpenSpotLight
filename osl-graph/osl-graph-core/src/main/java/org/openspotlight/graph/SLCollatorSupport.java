...
public class SLCollatorSupport {
     ...
     */
    public static String getCollatorKeyPropName( String name,
     ...
     */
    public static String getCollatorDescriptionPropName( String name,
                                                         int collatorStrength ) {
        String propName = null;
        switch (collatorStrength) {
            case Collator.PRIMARY:
     ...
     */
    public static String getCollatorKey( int strength,
                                         String value ) {
     ...
     */
    public static String getCollatorDescription( int strength,
                                                 String value ) {
        switch (strength) {
     ...
     */
    public static Collator getPropertyCollator( Class<?> nodeType,
                                                String name ) {
     ...
     */
    private static Method getSetterMethod( Class<?> type,
                                           String name ) {
        Method method = null;
        try {
     ...
     */
    private static Method getGetterMethod( Class<?> type,
                                           String name ) {
        Method method = null;
        try {
