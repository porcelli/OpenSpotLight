...
public class WhereLinkTypeInfo {
    ...
    public static class SLLinkTypeStatementInfo implements Serializable {
         ...
         */
        public void setTypeInfo( WhereLinkTypeInfo typeInfo ) {
            this.typeInfo = typeInfo;
        }
         ...
         * @return the sL condition info
         */
        public SLLinkTypeConditionInfo addCondition( ConditionalOperatorType operator ) {
        ...
        private void printWhereStatement( StringBuilder buffer,
                                          SLLinkTypeStatementInfo statementInfo,
                                          int tabLevel ) {
