...
/**
 * The listener interface for receiving SLLinkCount events. The class that is interested in processing a SLLinkCount event
 * implements this interface, and the object created with that class is registered with a component using the component's
 * <code>addSLLinkCountListener<code> method. When
