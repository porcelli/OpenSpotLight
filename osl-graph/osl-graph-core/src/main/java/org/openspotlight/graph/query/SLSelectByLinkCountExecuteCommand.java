...
public class SLSelectByLinkCountExecuteCommand extends SLSelectAbstractCommand {
    ...
    class LinkCountMapper {
         ...
         */
        private LinkCountMapper(
                                 SLWhereTypeInfo whereTypeInfo, List<PNodeWrapper> inputNodeWrappers ) {
         ...
         */
        private int getLinkCount( SLConditionInfo conditionInfo,
                                  String id ) {
         ...
         * @throws SLPersistentTreeSessionException the SL persistent tree session exception
         */
        private Collection<PNodeWrapper> getNodeWrappers( Collection<SLPersistentNode> pLinkNodes,
                                                          SLSideType side ) throws SLPersistentTreeSessionException {
        ...
        private void updateNumberOcurrences( Map<String, Integer> map,
                                             Collection<PNodeWrapper> nodeWrappers,
                                             SLSideType side ) throws SLPersistentTreeSessionException {
         ...
         * @throws SLPersistentTreeSessionException the SL persistent tree session exception
         */
        private Map<String, Integer> createNodeOccurencesMap( List<PNodeWrapper> nodeWrappers )
    ...
    class LinkCountEvaluator {
         ...
         */
        private LinkCountEvaluator(
                                    SLWhereTypeInfo whereTypeInfo, LinkCountMapper mapper ) {
            this.whereTypeInfo = whereTypeInfo;
            this.mapper = mapper;
        }
         ...
         * @return true, if successful
         */
        private boolean evaluate( SLTypeStatementInfo statementInfo,
                                  String id ) {
