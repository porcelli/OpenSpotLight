...
public class GraphReaderImpl implements GraphReader {
    ...
    @Override
    public <L extends Link> Iterable<L> getUnidirectionalLinksBySource( Class<L> linkClass,
                                                                        Node source ) {
        throw new UnsupportedOperationException();
    ...
    @Override
    public <L extends Link> Iterable<L> getUnidirectionalLinksByTarget( Class<L> linkClass,
                                                                        Node target ) {
        throw new UnsupportedOperationException();
    ...
    @Override
    public <L extends Link> L getLink( Class<L> linkTypeClass,
                                       Node source,
                                       Node target,
    ...
    @Override
    public <N extends Node> Iterable<N> getLinkedNodes( Class<? extends Link> linkClass,
                                                        Node node,
                                                        Class<N> nodeClass,
                                                        boolean returnSubTypes,
                                                        LinkType linkDirection )
