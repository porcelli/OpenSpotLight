...
public class GraphTransientWriterImpl implements GraphTransientWriter {
     ...
     */
    @Override
    public <T extends Node> T addTransientChildNode(final Node parent,
                                                     final Class<T> clazz,
                                                     final String name)
     ...
     */
    @Override
    public <T extends Node> T addTransientNode(final Context context,
                                                final Class<T> clazz,
                                                final String name)
        throws IllegalArgumentException {
        throw new UnsupportedOperationException();
     ...
     */
    @Override
    public <L extends Link> L createTransientLink(final Class<L> linkClass,
                                                   final Node source,
                                                   final Node target)
        throws IllegalArgumentException {
        throw new UnsupportedOperationException();
