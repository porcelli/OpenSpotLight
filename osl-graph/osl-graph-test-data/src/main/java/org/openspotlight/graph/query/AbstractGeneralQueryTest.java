...
public abstract class AbstractGeneralQueryTest {
	...
	protected boolean appearsAfter(NodeWrapper[] wrappers, String firstType,
			String firstStr, String afterType, String afterStr) {
		return appearsAfter(wrappers, firstType, "java.util", firstStr,
				afterType, "java.util", afterStr);
	}

	protected boolean appearsAfter(NodeWrapper[] wrappers, String firstType,
			String firstParent, String firstStr, String afterType,
			String afterParent, String afterStr) {
