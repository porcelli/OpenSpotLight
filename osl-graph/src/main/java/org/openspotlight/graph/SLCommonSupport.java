...
public class SLCommonSupport {
	 ...
	 * @throws SLPersistentTreeSessionException the SL persistent tree session exception
	 */
	public static <T extends Serializable> SLPersistentProperty<T> getProperty(SLPersistentNode pNode, Class<T> clazz, String name) throws SLPersistentTreeSessionException {
