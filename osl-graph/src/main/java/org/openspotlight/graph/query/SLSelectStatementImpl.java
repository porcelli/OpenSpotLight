...
public class SLSelectStatementImpl implements SLSelectStatement, SLSelectInfoGetter, SLSelectStatementInfoGetter {
	 ...
	 */
	public SLSelectStatementImpl(SLSelectFacade selectFacade) {
	...
	public static class AllTypesImpl implements AllTypes {
		 ...
		 */
		public AllTypesImpl(SLSelectStatement selectStatement, SLAllTypesInfo allTypesInfo, List<ByLink> byLinks) {
	...
	public static class TypeImpl implements Type {
		 ...
		 */
		TypeImpl(SLSelectStatement selectStatement, SLSelectTypeInfo typeInfo, List<ByLink> byLinks) {
			this.selectStatement = selectStatement;
	...
	public static class ByLinkImpl implements ByLink {
		 ...
		 */
		public ByLinkImpl(SLSelectStatement select, SLSelectByLinkInfo byLinkInfo) {
			this.select = select;
