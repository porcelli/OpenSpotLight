 ...
 */
public class SLWhereByNodeTypeInfo {
	
	/** The select by node type info. */
	private SLSelectByNodeTypeInfo selectByNodeTypeInfo;
	 ...
	 */
	public SLWhereByNodeTypeInfo(SLSelectByNodeTypeInfo selectByNodeTypeInfo) {
	 ...
	 */
	public void setSelectByNodeTypeInfo(SLSelectByNodeTypeInfo selectByNodeTypeInfo) {
		this.selectByNodeTypeInfo = selectByNodeTypeInfo;
	}
