...
public class SLQueryApiImpl extends AbstractSLQuery implements SLQueryApi {
	 ...
	 */
	public SLQueryApiImpl(SLGraphSession session, SLPersistentTreeSession treeSession) {
     ...
     */
	private void validateSelectStatementInfoBeforeNormalization(SLSelectStatementInfo selectInfo) throws SLGraphSessionException, SLInvalidQuerySyntaxException {
