...
public class SLNodeEvent extends SLGraphSessionEvent {
	 ...
	 */
	public SLNodeEvent(int type, SLNode node, SLPersistentNode pNode, Collection<Class<? extends SLLink>> linkTypesForLinkDeletion, Collection<Class<? extends SLLink>> linkTypesForLinkedNodeDeletion) {
