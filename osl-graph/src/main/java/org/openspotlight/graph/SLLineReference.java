...
public interface SLLineReference extends SLNode {
	...
	/** The Constant LINE_TYPE_1. */
	public static final int LINE_TYPE_1 = 1;
	
	/** The Constant LINE_TYPE_2. */
	 ...
	 */
	@SLProperty
	public String getPath() throws SLGraphSessionException;
	 ...
	 * @throws SLGraphSessionException the SL graph session exception
	 */
	public void setPath(String path) throws SLGraphSessionException;
