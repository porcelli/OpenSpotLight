...
class Status {
	...
	public static final int STATUS_ROLLING_BACK = 2;
	public static final int STATUS_COMMITTED = 3;
	public static final int STATUS_COMMITTING = 4;
	public static final int STATUS_PREPARED = 5;
	public static final int STATUS_PREPARING = 6;
	public static final int STATUS_NO_TRANSACTION = 7;
	public static final int STATUS_MARKED_ROLLBACK = 8;
