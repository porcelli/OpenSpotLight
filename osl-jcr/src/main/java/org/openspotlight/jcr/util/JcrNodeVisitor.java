...
/**
 * A class for helping visiting {@link Node Jcr Nodes}. It is "stackoverflow safe", since it is not recursive.
 * 
...
public final class JcrNodeVisitor implements ItemVisitor {
    ...
    public static interface ErrorHandler {
        ...
        /**
         * Method to handle error during {@link NodeVisitor#visiting(Node)} method call.
         * 
         * @param <E>
         * @param nodeWithError
         * @param exception
    ...
    public static interface NodeVisitor {
        /**
         * Callback method. It's not necessary to go inside the children here. The {@link JcrNodeVisitor} will do all the job.
         * 
         * @param n
    ...
    /**
     * Static helper class to fill the visiting queue and avoid stack overflow during visiting.
     * 
     * @author Luiz Fernando Teston - feu.teston@caravelatech.com
     */
    ...
    /**
     * Creates an {@link ItemVisitor} to visit the nodes with a level limit and a {@link ErrorHandler} to handle internal errors.
     * 
     * @param visitor
     * @param limit
     * @param handler
