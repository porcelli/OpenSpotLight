    ...
    public static Set<SimpleNodeType> fillItems( final SimpleNodeType rootNode,
        ...
        looping: for (final PropertyDescriptor desc : allDescriptors) {
            ...
            if (SimpleNodeType.class.isAssignableFrom(currentType)) {
                ...
                final UnwrappedCollectionTypeFromMethodReturn<Object> metadata = Reflection.unwrapCollectionFromMethodReturn(readMethod);
                ...
                final UnwrappedMapTypeFromMethodReturn<Object, Object> metadata = Reflection.unwrapMapFromMethodReturn(readMethod);
