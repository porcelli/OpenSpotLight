...
//		LevelThreeObj anotherLevelThree = SimplePersistSupport
//				.convertNodeToBean(session, asJcr);
//		assertThat(anotherLevelThree.getObjMap().size(), Is.is(1));
//		assertThat(anotherLevelThree.getObjMap().get(2).getValue(), Is
//				.is(obj1.getValue()));
//		assertThat(anotherLevelThree.getObjMap().get(2).getName(), Is
//				.is(obj1.getName()));
//
//		obj1.setValue(4);
//		asJcr = simplePersist.convertBeanToNode("a/b/c", session,
...
//		anotherLevelThree = simplePersist.convertNodeToBean(session,
//				asJcr);
//		assertThat(anotherLevelThree.getObjMap().size(), Is.is(0));
//	}
//
//	@Test
...
//				.convertNodeToBean(session, node, LazyType.EAGER);
...
//		assertThat(convertedFromJcr.getObjMap().get(1).getName(), Is
//				.is("1"));
//		assertThat(convertedFromJcr.getObjMap().get(2).getName(), Is
//				.is("2"));
//		assertThat(convertedFromJcr.getObjMap().get(3).getName(), Is
//				.is("3"));
//
...
//		obj1.setValue(5);
//		levelThree.getObjList().add(obj1);
//		final STNodeEntry asJcr = simplePersist.convertBeanToNode("d/b/c",
//				session, levelThree);
...
//		assertThat(result1.size(), Is.is(1));
//		assertThat(result3.size(), Is.is(1));
//		assertThat(result2.size(), Is.is(1));
...
//		object3.setKey2(1);
//
//		simplePersist.convertBeanToNode("a/b/c", session, object1);
//		simplePersist.convertBeanToNode("a/b/c", session, object2);
//		simplePersist.convertBeanToNode("a/b/c", session, object3);
//		session.save();
...
//		assertThat(foundNodes.size(), Is.is(2));
//	}
//
//	@Test
...
//
//		simplePersist.convertBeanToNode("a/b/c", session, obj1);
//		simplePersist.convertBeanToNode("a/b/c", session, obj2);
//		session.save();
