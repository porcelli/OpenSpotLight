 ...
 * Boston, MA  02110-1301  USA
 */
package org.openspotlight.bundle.dap.java;
...
public class ExampleGraphImport {
    ...
    public void shouldImportSomeData() throws Exception {
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.bpm", "SeamUserCodeInterceptor$ContextualCall", 1056);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.contexts", "AbstractEntityBeanCollection", 1056);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeInterface.class,"org.jboss.seam.core", "Expressions$MethodExpression", 1537);
        newType = helper.addBeforeTypeProcessing(JavaTypeInterface.class,"org.jboss.seam.core", "Expressions$ValueExpression", 1537);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "AbstractClassDeploymentHandler", 1057);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "AbstractDeploymentHandler", 1057);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "AnnotationDeploymentHandler$AnnotationDeploymentHandlerMetadata", 32);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "AnnotationDeploymentHandler", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeInterface.class,"org.jboss.seam.deployment", "ClassDeploymentHandler", 1537);
        newType = helper.addBeforeTypeProcessing(JavaTypeInterface.class,"org.jboss.seam.deployment", "ClassDeploymentMetadata", 1537);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "ClassDescriptor", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "ComponentDeploymentHandler$1", 32);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "ComponentDeploymentHandler", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "ComponentsXmlDeploymentHandler$1", 32);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "ComponentsXmlDeploymentHandler", 33);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "DotComponentDotXmlDeploymentHandler$1", 32);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "DotComponentDotXmlDeploymentHandler", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "DotPageDotXmlDeploymentHandler$1", 32);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "DotPageDotXmlDeploymentHandler", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "FileDescriptor", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "ForwardingAbstractScanner", 1057);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "ForwardingDeploymentStrategy", 1057);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "GroovyDeploymentHandler$GroovyDeploymentHandlerMetadata", 32);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "GroovyDeploymentHandler", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "GroovyHotDeploymentStrategy", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "HotDeploymentStrategy", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "NamespaceDeploymentHandler$1", 32);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "NamespaceDeploymentHandler", 33);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "StandardDeploymentStrategy", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "TimestampCheckForwardingDeploymentStrategy$1", 32);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "TimestampCheckForwardingDeploymentStrategy", 1057);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.deployment", "WarRootDeploymentStrategy", 33);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.el", "OptionalParameterMethodExpression", 32);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeEnum.class,"org.jboss.seam.exception", "ExceptionHandler$LogLevel", 16433);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.init", "ComponentDescriptor$PrecedenceComparator", 33);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.init", "Initialization$EventListenerDescriptor", 32);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeInterface.class,"org.jboss.seam.intercept", "OptimizedInterceptor", 1537);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeEnum.class,"org.jboss.seam.international", "StatusMessage$Severity", 16433);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.jsf", "SeamApplication$ConverterLocator", 32);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.mock", "AbstractDBUnitSeamTest$DataSetOperation", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeEnum.class,"org.jboss.seam.mock", "AbstractDBUnitSeamTest$Database", 16433);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.mock", "AbstractDBUnitSeamTest", 1057);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.mock", "AbstractSeamTest$ComponentTest", 1057);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.mock", "AbstractSeamTest$FacesRequest", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.mock", "AbstractSeamTest$NonFacesRequest", 33);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.mock", "MockExternalContext$AttributeMap$1", 32);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.mock", "MockExternalContext$AttributeMap", 1056);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeInterface.class,"org.jboss.seam.navigation", "ConversationIdParameter", 1537);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.navigation", "NaturalConversationIdParameter", 33);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.navigation", "RedirectNavigationHandler", 49);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.navigation", "SyntheticConversationIdParameter", 33);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.persistence", "AbstractPersistenceProvider", 1057);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.persistence", "EntityManagerProxyInterceptor", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.persistence", "Filter", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.persistence", "FullTextEntityManagerProxy", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.persistence", "FullTextHibernateSessionProxy", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.persistence", "HibernatePersistenceProvider$NotHibernateException", 32);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.persistence", "HibernatePersistenceProvider", 33);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.persistence", "HibernateSessionProxyInterceptor", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.persistence", "ManagedEntityInterceptor", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.persistence", "ManagedEntityWrapper", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.persistence", "ManagedHibernateSession$1", 32);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.persistence", "ManagedHibernateSession", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.persistence", "ManagedPersistenceContext$1", 32);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.persistence", "ManagedPersistenceContext", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeInterface.class,"org.jboss.seam.persistence", "PersistenceContextManager", 1537);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security", "HibernateSecurityInterceptor", 33);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security", "RememberMe$UsernameSelector", 32);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security", "SecurityInterceptor$Restriction", 32);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.digest", "DigestAuthenticator", 1057);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.digest", "DigestValidationException", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.jaas", "SeamLoginModule", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.management", "IdentityManagementException", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.management", "IdentityManager$1", 32);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.management", "IdentityManager$2", 32);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.management", "IdentityManager$3", 32);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.management", "IdentityManager$4", 32);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.management", "IdentityManager", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeEnum.class,"org.jboss.seam.security.management", "IdentityStore$Feature", 16433);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.management", "IdentityStore$FeatureSet", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeInterface.class,"org.jboss.seam.security.management", "IdentityStore", 1537);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.management", "JpaIdentityStore", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.management", "LdapIdentityStore", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.management", "NoSuchRoleException", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.management", "NoSuchUserException", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.management", "PasswordHash", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.management.action", "RoleAction", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.management.action", "RoleSearch", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.management.action", "UserAction", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.management.action", "UserSearch", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeInterface.class,"org.jboss.seam.security.management", "package-info", 512);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.permission", "ClassIdentifierStrategy", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.permission", "EntityIdentifierStrategy", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.permission", "IdentifierPolicy", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeInterface.class,"org.jboss.seam.security.permission", "IdentifierStrategy", 1537);
        newType = helper.addBeforeTypeProcessing(JavaTypeEnum.class,"org.jboss.seam.security.permission", "JpaPermissionStore$Discrimination", 16432);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.permission", "JpaPermissionStore", 33);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.permission", "PermissionManager", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.permission", "PermissionMapper", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.permission", "PermissionMetadata$ActionSet", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.permission", "PermissionMetadata", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeInterface.class,"org.jboss.seam.security.permission", "PermissionResolver", 1537);
        newType = helper.addBeforeTypeProcessing(JavaTypeInterface.class,"org.jboss.seam.security.permission", "PermissionStore", 1537);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.permission", "PersistentPermissionResolver", 33);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.permission", "RuleBasedPermissionResolver", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.security.permission.action", "PermissionSearch", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeInterface.class,"org.jboss.seam.security.permission", "package-info", 512);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.servlet", "ContextualHttpServletRequest", 1057);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.servlet", "ResourceServlet", 131105);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.servlet", "SeamCharacterEncodingFilter", 131105);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.text", "SeamTextParser$DefaultSanitizer", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.text", "SeamTextParser$HtmlRecognitionException", 33);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.transaction", "AbstractUserTransaction", 1057);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeInterface.class,"org.jboss.seam.transaction", "LocalEjbSynchronizations", 1537);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.transaction", "TransactionInterceptor$1", 32);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.transaction", "TransactionInterceptor$TransactionMetadata", 32);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.util", "Conversions$AssociativePropertyValue", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.util", "Conversions$BigDecimalConverter", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.util", "Conversions$BigIntegerConverter", 33);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.util", "Conversions$PropertiesConverter", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeInterface.class,"org.jboss.seam.util", "Conversions$PropertyValue", 1537);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.util", "Conversions$SetConverter", 33);
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.util", "Conversions$StringArrayConverter", 33);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.util", "DelegatingInvocationHandler$MethodTarget", 32);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeClass.class,"org.jboss.seam.web", "MultipartRequestImpl$FileParam$1", 32);
        ...
        newType = helper.addBeforeTypeProcessing(JavaTypeEnum.class,"org.jboss.seam.web", "MultipartRequestImpl$ReadState", 16432);
