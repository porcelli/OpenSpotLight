...
<#list package.linkData as link>
    ...
    <file>
        ...
        <location>bundle-processor/osl-${package.@packageName}-bundle/src/main/java/org/openspotlight/bundle/${package.@packageName}/metamodel/link</location>
        <content>
/*
 ...
 * Boston, MA  02110-1301  USA
 */
package org.openspotlight.bundle.${package.@packageName}.metamodel.link;
