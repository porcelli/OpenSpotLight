...
public class JavaPublicElementsPhaseStressTest {
	...
	public void setupResources() throws Exception {
		...
		final String oslParentPath = new File("../../..").getCanonicalPath();
		String oslPath = new File("../..").getCanonicalPath();
		oslPath = Strings.removeBegginingFrom(oslParentPath + "/", oslPath);
		includedSource.setInitialLookup(oslParentPath);
		...
		bundleSource.setRelative(oslPath);
