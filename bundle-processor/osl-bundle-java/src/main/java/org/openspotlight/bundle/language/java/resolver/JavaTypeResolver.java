...
/**
 * The Class JavaTypeResolver is a {@link TypeResolver} used for Java
...
public class JavaTypeResolver extends AbstractTypeResolver<JavaType> {
	...
	private class ByNameTypeFinder extends DolarReplacerQueryExecutor {
		 ...
		 *            the s
		 */
		public ByNameTypeFinder(final String s) {
			super(s);
		}
	...
	/**
	 * This class executes a query replacing the dolar character '$' by dot to
	 * fill the way that Java Programming Language works.
	 */
	...
	private class TypesFromTheSamePackageQueryExecutor extends
		 ...
		 * @param typeToSolve
		 *            the type to solve
		 * @param allTypesFromSamePackages
		 *            the all types from same packages
		 */
		public TypesFromTheSamePackageQueryExecutor(final String typeToSolve,
	...
	/**
	 * Creates the new uncached and slow java type finder. Normaly its better to
	 * use the method
	 * {@link #createNewCached(SLContext, List, boolean, SLGraphSession)}. This
	 * method is here only to be used on tests.
	 * 
	 * @param abstractContext
	 *            the abstract context
	 * @param orderedActiveContexts
	...
	/**
	 * Instantiates a new java type resolver. Normaly should be better to use
	 ...
	 *            the session
	 */
	protected JavaTypeResolver(final SLContext abstractContext,
			final List<SLContext> orderedActiveContexts,
			final boolean enableBoxing, final SLGraphSession session) {
	 ...
	 * #bestMatch(org.openspotlight.graph.SLNode,
	...
	public <T extends JavaType> BestTypeMatch bestMatch(final T reference,
			final T t1, final T t2) throws InternalJavaFinderError {
		try {
	 ...
	 * @see
	 * org.openspotlight.bundle.dap.language.java.resolver.AbstractTypeResolver
	 * #countAllChildren(org.openspotlight.graph.SLNode,
	 ...
	 * @see
	 * org.openspotlight.bundle.dap.language.java.resolver.AbstractTypeResolver
	 * #countAllParents(org.openspotlight.graph.SLNode,
	 * org.openspotlight.bundle.
	 * dap.language.java.resolver.TypeResolver.IncludedResult)
	 */
	@Override
	 ...
	 * @see
	 * org.openspotlight.bundle.dap.language.java.resolver.AbstractTypeResolver
	 * #countConcreteChildren(org.openspotlight.graph.SLNode,
	 * org.openspotlight.bundle
	 * .dap.language.java.resolver.TypeResolver.IncludedResult)
	 */
	@Override
	 ...
	 * @see
	 * org.openspotlight.bundle.dap.language.java.resolver.AbstractTypeResolver
	 * #countConcreteParents(org.openspotlight.graph.SLNode,
	 * org.openspotlight.bundle
	 * .dap.language.java.resolver.TypeResolver.IncludedResult)
	 */
	@Override
	 ...
	 * @see
	 * org.openspotlight.bundle.dap.language.java.resolver.AbstractTypeResolver
	 * #countInterfaceChildren(org.openspotlight.graph.SLNode,
	 * org.openspotlight.
	 ...
	 * @see
	 * org.openspotlight.bundle.dap.language.java.resolver.AbstractTypeResolver
	 * #countInterfaceParents(org.openspotlight.graph.SLNode,
	 * org.openspotlight.bundle
	 * .dap.language.java.resolver.TypeResolver.IncludedResult)
	 */
	@Override
	 ...
	 * @see
	 * org.openspotlight.bundle.dap.language.java.resolver.AbstractTypeResolver
	 * #getAllChildren(org.openspotlight.graph.SLNode,
	...
	protected <T extends JavaType, A extends JavaType> List<T> getAllChildrenByAllLinkTypes(
			...
			final IncludedResult includedResult, final Recursive recursive)
			throws InternalJavaFinderError {
		try {
	 ...
	 * @see
	 * org.openspotlight.bundle.dap.language.java.resolver.AbstractTypeResolver
	 * #getAllParents(org.openspotlight.graph.SLNode,
	 * org.openspotlight.bundle.dap
	 * .language.java.resolver.TypeResolver.ResultOrder,
	 * org.openspotlight.bundle
	 * .dap.language.java.resolver.TypeResolver.IncludedResult)
	 ...
	 * @see
	 * org.openspotlight.bundle.dap.language.java.resolver.AbstractTypeResolver
	 * #getConcreteChildren(org.openspotlight.graph.SLNode,
	 * org.openspotlight.bundle
	 ...
	 * @see
	 * org.openspotlight.bundle.dap.language.java.resolver.AbstractTypeResolver
	 * #getConcreteParents(org.openspotlight.graph.SLNode,
	 * org.openspotlight.bundle
	 * .dap.language.java.resolver.TypeResolver.ResultOrder,
	 * org.openspotlight.bundle
	 * .dap.language.java.resolver.TypeResolver.IncludedResult)
	 ...
	 * @see
	 * org.openspotlight.bundle.dap.language.java.resolver.AbstractTypeResolver
	 * #getInterfaceChildren(org.openspotlight.graph.SLNode,
	 * org.openspotlight.bundle
	 * .dap.language.java.resolver.TypeResolver.ResultOrder,
	 * org.openspotlight.bundle
	 * .dap.language.java.resolver.TypeResolver.IncludedResult)
	 ...
	 * @see
	 * org.openspotlight.bundle.dap.language.java.resolver.AbstractTypeResolver
	 * #getInterfaceParents(org.openspotlight.graph.SLNode,
	 * org.openspotlight.bundle
	 * .dap.language.java.resolver.TypeResolver.ResultOrder,
	 * org.openspotlight.bundle
	 * .dap.language.java.resolver.TypeResolver.IncludedResult)
	...
	public <T extends JavaType, A extends T> T getType(
			final String typeToSolve, final A activeType,
	...
	private <T extends JavaType, A extends JavaType> T getUniqueResult(
			final A type, final Class<? extends SLLink> linkType)
			throws InternalJavaFinderError {
		try {
	...
	public <T extends JavaType, A extends JavaType> boolean isTypeOf(
			final T implementation, final A superType)
			throws InternalJavaFinderError {
		try {
	 ...
	 * @param order
	 *            the order
	 * @param typedInheritedTypes
	 *            the typed inherited types
	 * @return the list< t>
	 */
