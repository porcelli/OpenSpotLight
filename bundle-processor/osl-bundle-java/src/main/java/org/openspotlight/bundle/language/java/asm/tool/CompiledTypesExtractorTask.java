...
/**
 * This class is an {@link Task ant task} that reads compiled artifacts and
 * generates an XML File with all declared java types.
 * 
 * @author porcelli
 */
public class CompiledTypesExtractorTask extends Task {
	 ...
	 * 
	 * @param xmlOutputFileName
	 *            the new xml output file name
	 */
