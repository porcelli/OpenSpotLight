...
<#list nodes.nodeData as node>
    ...
    <file>
        ...
        <location>bundle-processor/osl-java-bundle/src/main/java/org/openspotlight/parser/dap/language/${package.@packageName}/node</location>
        <content>
/*
 ...
 * Boston, MA  02110-1301  USA
 */
package org.openspotlight.parser.dap.language.${package.@packageName}.node;
