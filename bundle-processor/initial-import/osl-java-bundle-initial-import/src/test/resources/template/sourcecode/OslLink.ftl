...
<#list package.linkData as link>
    ...
    <file>
        ...
        <location>bundle-processor/osl-java-bundle/src/main/java/org/openspotlight/parser/dap/language/${package.@packageName}/link</location>
        <content>
/*
 ...
 * Boston, MA  02110-1301  USA
 */
package org.openspotlight.parser.dap.language.${package.@packageName}.link;
