...
public class SourceLineInfoAggregator {
	...
	private enum LineState {
		NONE, EMPTY, HIDDEN, STATEMENT, STATEMENT_CONTINUATION
	}
	...
	public void addCodeArea(final TokenStream tokenInput, final int area) {
	...
	private SimpleSourceLineInfo getSimpleLineSourceInfo(
			final String sourceName, int lineStart, int lineEnd) {
	...
	public void setCode(final SLArtifactStream input, final int line) {
		setupSource(input);
	...
	public void setCode(final TokenStream tokenInput, final int startIndex,
			final int endIndex) {
	...
	public void setComment(final SLArtifactStream input, final int lineStart,
	...
	private void setHiddenCode(final String sourceName, final int line) {
	...
	private void setLineCode(final SLCommonToken token, final LineState state) {
	...
	private void setLineComment(final String sourceName, final int line,
	...
	private void setLineWhitespace(final String sourceName, final int line) {
		final Map<Integer, LineState> lineMapSource = lineMap.get(sourceName);
	...
	public void setWhitespace(final SLArtifactStream input,
			final int lineStart, final int endLine) {
		setupSource(input);
