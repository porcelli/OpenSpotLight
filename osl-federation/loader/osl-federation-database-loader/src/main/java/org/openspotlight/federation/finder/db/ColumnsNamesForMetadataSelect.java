...
/**
 * Valid column names to be used on a Metadata select statement. For "documentation purposes" this was created as a enum, to make
 * explict (also in compiled versions) the column names needed on select statements.
 * 
