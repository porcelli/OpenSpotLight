...
import org.openspotlight.bundle.context.SingleGraphSessionExecutionContextFactoryModule;
...
public class BundleProcessorManagerTest {
    ...
    public void shouldProcessMappedArtifactsUsingJcrStreamArtifacts() throws Exception {
        ...
        Injector injector = Guice.createInjector(new JRedisStorageModule(StStStorageSessionMode.AUTO,
                ...
                new SingleGraphSessionExecutionContextFactoryModule(), new SLGraphModule(DefaultJcrDescriptor.TEMP_DESCRIPTOR));

        JRedis jredis = injector.getInstance(JRedisFactory.classRegularPartitionrPartitionrPartition.GRAPH);
        jredis.flushall();
