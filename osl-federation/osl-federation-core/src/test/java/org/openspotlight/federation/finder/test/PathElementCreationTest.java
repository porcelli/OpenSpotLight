...
public class PathElementCreationTest {
    ...
    @Test
    public void shouldCreateCorrectPathElement()
        throws Exception {
    ...
    @Test
    public void shouldCreateCorrectPathElementUsingDots()
        throws Exception {
        final PathElement pathElement = PathElement.createFromPathString("a/b/c/././d/e");
        assertThat(pathElement.getCompletePath(), is("/a/b/c/d/e"));
    }
    ...
    @Test
    public void shouldCreateCorrectPathElementUsingDoubleDots()
        throws Exception {
        final PathElement pathElement = PathElement.createFromPathString("a/b/c/../../d/e");
    ...
    @Test
    public void shouldCreateCorrectPathElementWithRelativePath()
        throws Exception {
    ...
    @Test
    public void shouldCreateCorrectRelativePathUsingDots()
        throws Exception {
        final PathElement pathElement = PathElement.createFromPathString("a/b/c/d/e/");
    ...
    @Test
    public void shouldCreateCorrectRelativePathUsingDoubleDots()
        throws Exception {
        final PathElement pathElement = PathElement.createFromPathString("a/b/c/d/e/");
        final PathElement newRelativePathElement = PathElement.createRelativePath(pathElement, "../../f");
    ...
    @Test
    public void shouldGetCorrectParentPathElement()
        throws Exception {
        final PathElement pathElement = PathElement.createFromPathString("a/b/c/d/e");
    ...
    @Test
    public void shouldGetCorrectParentPathElement2()
        throws Exception {
        final PathElement pathElement = PathElement.createFromPathString("/a/b/c/d/e");
        final PathElement parentPathElement = PathElement.createFromPathString("a/b/c/d");
        assertThat(pathElement.getParent(), is(parentPathElement));
