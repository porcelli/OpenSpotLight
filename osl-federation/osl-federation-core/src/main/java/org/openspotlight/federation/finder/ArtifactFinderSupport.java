...
public class ArtifactFinderSupport {
    ...
    public static <T extends Artifact> T findTheEquivalent(final T artifact,
        ...
        for (final T equivalent: setWithEquivalent) {
            if (equivalent.getArtifactCompleteName().equals(
                    artifact.getArtifactCompleteName())) { return equivalent; }
        }
        return null;
    }
    ...
    public static <T extends Artifact> void freezeChangesAfterBundleProcessing(
                                                                               ...
                                                                               final PersistentArtifactManager manager) {
        ...
        if (manager != null) {
            final Iterable<StorageNode> nodesToExclude = manager.getSimplePersist()
                    .convertBeansToNodes(toBeRemoved);
            for (final StorageNode nodeToExclude: nodesToExclude) {
