...
public final class StreamArtifactAboutToChange implements ConfigurationNode, GeneratedNode, ArtifactAboutToChange {
    ...
    public String getUUID() {
        return this.instanceMetadata.getProperty(ArtifactAboutToChange.KeyProperties.UUID.toString());
    }
    ...
    public String getVersionName() {
        return this.instanceMetadata.getProperty(ArtifactAboutToChange.KeyProperties.version.toString());
    }
