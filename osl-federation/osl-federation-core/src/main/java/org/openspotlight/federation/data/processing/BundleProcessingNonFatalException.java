 ...
 * 
 */
public class BundleProcessingNonFatalException extends SLException {
    /**
     * 
     */
    private static final long serialVersionUID = -812916844847663558L;
    
    /**
     * Constructor as the same signature as the super constructor.
     */
    public BundleProcessingNonFatalException() {
        super();
    }
     ...
     * @param message
     */
    public BundleProcessingNonFatalException(final String message) {
        super(message);
    }
     ...
     * @param cause
     */
    public BundleProcessingNonFatalException(final Throwable cause) {
        super(cause);
    }
