...
public class SingleGraphSessionExecutionContext extends DefaultExecutionContext {
    ...
    private final GraphReadGraphReadGraphReaderhSessionExecutionContext(
                                        ...
                                        final AuthenticatedUser user, final GraphReader uniqueGraphReader       GraphReader       SimplePersistFactory simplePersistFactory, DetailedLoggerProvider detailedLoggerProvider, SLGraph graph ) {
    ...
    @Override
    public GraphReader getGraphSessionGraphReaderuniqueGraphSessiGraphReaderride
