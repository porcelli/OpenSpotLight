...
public class UniqueKeyImpl implements UniqueKey {
    ...
    public UniqueKeyImpl(final LocalKey localKey, final String parentKeyAsString, final Partition partition,
    ...
    public boolean equals(final Object o) {
        ...
        final UniqueKeyImpl uniqueKey = (UniqueKeyImpl) o;
    ...
    @Override
    public int compareTo(final UniqueKey that) {
