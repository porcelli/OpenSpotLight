...
public class PropertyImpl implements Property {
    ...
    public static PropertyImpl createSimple( String name,
                                               PropertyContainer parent ) {
        PropertyImpl property = new PropertyImpl(name, parent, false, false);
        return property;
    }

    public static PropertyImpl createIndexed( String name,
                                                PropertyContainer parent ) {
        PropertyImpl property = new PropertyImpl(name, parent, true, false);
        return property;
    }

    public static PropertyImpl createKey( String name,
                                            PropertyContainer parent ) {
        PropertyImpl property = new PropertyImpl(name, parent, true, true);
        return property;
    }

    private PropertyImpl( String name, PropertyContainer parent, boolean indexed, boolean key ) {
        this.name = name;
        this.parent = parent;
    ...
    @Override
    public void setStringValue( StorageSession session,
                                String value ) {
    ...
    @Override
    public void setBytesValue( StorageSession session,
                               byte[] value ) {
        propertyValue.setDirty(true);
        propertyValue.setValue(value);
        ((AbstractStorageSession<?>)session).propertySetProperty(this, propertyValue.getValueAsBytes());
    ...
    @Override
    public void setStreamValue( StorageSession session,
                                InputStream value ) {
        propertyValue.setDirty(true);
        propertyValue.setValue(value);
        ((AbstractStorageSession<?>)session).propertySetProperty(this, propertyValue.getValueAsBytes());
    ...
    public void setStringValueOnLoad( StorageSession session,
                                      String value ) {
        propertyValue.setValue(value);
        propertyValue.setDirty(false);
        propertyValue.setLoaded(true);
    ...
    public void setBytesValueOnLoad( StorageSession session,
                                     byte[] value ) {
        propertyValue.setValue(value);
        propertyValue.setDirty(false);
        propertyValue.setLoaded(true);
