...
public class RepositoryPath {
    ...
    public static RepositoryPath repositoryPath(final String repositoryPath) {
    ...
    public boolean equals(final Object o) {
        ...
        final RepositoryPath that = (RepositoryPath) o;

        if (repositoryPath != null ? !repositoryPath.equals(that.repositoryPath) : that.repositoryPath != null) { return false; }
