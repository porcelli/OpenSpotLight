...
public class JRedisSTStorageSessionImpl extends
    ...
    @Inject
    public JRedisSTStorageSessionImpl( FlushMode flushMode,
    ...
    @Override
    protected Set<STNodeEntry> internalFindByCriteria( Partition partition,
    ...
    protected final STNodeEntry createFoundEntryWithKey( UniqueKey uniqueKey ) {
    ...
    @Override
    protected Set<STNodeEntry> internalFindNamed( Partition partition,
