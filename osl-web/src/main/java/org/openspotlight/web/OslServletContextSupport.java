...
public class OslServletContextSupport implements ServletContextConstants {
	...
	public static AuthenticatedUser getAuthenticatedUerFrom(
			final ServletContext ctx) {
		return (AuthenticatedUser) ctx
				.getAttribute(ServletContextConstants.AUTHENTICATED_USER);
	}
	...
	public static SLGraph getGraphFrom(final ServletContext ctx) {
		return (SLGraph) ctx.getAttribute(ServletContextConstants.GRAPH);
	}
	 ...
	 */
	public static JcrConnectionProvider getJcrConnectionFrom(
			final ServletContext ctx) {
		return (JcrConnectionProvider) ctx
				.getAttribute(ServletContextConstants.PROVIDER);
	}
	//
	// /**
