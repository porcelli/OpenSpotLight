 ...
 * actions like sending messages to the {@link RemoteObjectServer} asking for
...
public class RemoteReference<T> implements Serializable {
	...
	/**
	 * The Interface ObjectMethods contains commons methods used on Object
	 * class. This is necessary for the proxy implementation.
	 */
	...
	public RemoteReference(final Class<T> remoteType,
