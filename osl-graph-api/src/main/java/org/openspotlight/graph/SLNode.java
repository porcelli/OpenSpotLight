...
public interface SLNode extends Comparable<SLNode> {
	 ...
	 * @throws SLGraphSessionException the SL graph session exception
	 */
	public <V extends Serializable> SLNodeProperty<V> getProperty(Class<V> clazz, String name, Collator collator) throws SLNodePropertyNotFoundException, SLInvalidNodePropertyTypeException, SLGraphSessionException;
