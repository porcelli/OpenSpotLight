...
/**
 * This component is a specialized component in PolicyEnforcement for Graph.
 * 
 * @author porcelli
 */
public class PolicyEnforcementGraphImpl implements PolicyEnforcement {
     ...
     */
    @Override
    public EnforcementResponse checkAccess(final EnforcementContext enforcementContext)
