...
/**
 * The Interface PolicyEnforcement. This is a common infrastructure to check policies. The goal of this interface is to be a much
 * purpose interface that can enforce several kind of policies. This component is inspired by
...
public interface PolicyEnforcement {
     ...
     * 
     * @param enforcementContext the enforcement context
     * @return the enforcement response
     * @throws EnforcementException the enforcement exception
     */
