...
/**
 * The Interface IdentityManager. This interface is responsible to manage actions related to identity manager (authenticate and
 * validate are some of its responsabilities).
 * 
 * @author porcelli
 */
public interface IdentityManager {
    ...
    public AuthenticatedUser authenticate( final User user,
                                           final String password ) throws IdentityException;
